    ...
    <div class="col">
        ...
        <form method="post" action="{{route('contacts.update',['id'=>$contact->id])}}">
            ...
            <div class="form-group">
                ...
                <input type="text" id="first_name" name="first_name" value="{{$contact->first_name}}" required class="form-control">
                @error('first_name')
            ...
            <div class="form-group">
                ...
                <input type="text" id="last_name" name="last_name" value="{{$contact->last_name}}" required class="form-control">
                @error('last_name')
                <div class="text-danger">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <input type="tel" id="phone" name="phone" value="{{$contact->phone}}" class="form-control">
                @error('phone')
                <div class="text-danger">{{ $message }}</div>
                @enderror
            </div>
